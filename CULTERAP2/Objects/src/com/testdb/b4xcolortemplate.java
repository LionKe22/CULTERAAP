...
public class b4xcolortemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.testdb.b4xcolortemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.testdb.b4xcolortemplate.class).invoke(this, new Object[] {null});
        else
...
public b4a.example.bitmapcreator _vvvvvvvvvvvvvvvvvvvv0 = null;
public float _vvvvvvvvvvvvvvvvvvvvv1 = 0f;
public float _vvvvvvvvvvvvvvvvvvvvv2 = 0f;
public float _vvvvvvvvvvvvvvvvvvvvv3 = 0f;
public float _vvvvvvvvvvvvvvvvvvvvv4 = 0f;
public float _vvvvvvvvvvvvvvvvvvvvv5 = 0f;
public b4a.example.bitmapcreator _vvvvvvvvvvvvvvvvvvvvv6 = null;
public int _dont_change = 0;
public com.testdb.b4xcolortemplate._colorpickerpart _vvvvvvvvvvvvvvvvvvvvv7 = null;
public com.testdb.b4xcolortemplate._colorpickerpart _vvvvvvvvvvvvvvvvvvvvv0 = null;
public com.testdb.b4xcolortemplate._colorpickerpart _vvvvvvvvvvvvvvvvvvvvvv1 = null;
public int _vvvvvvvvvvvvvvvvvvvvvv2 = 0;
public com.testdb.b4xdialog _vvvvvvvvvvvvvvvvvvvvvv3 = null;
public Object[] _vvvvvvvvvvvvvvvvvvvvvv4 = null;
...
if (_action==_vvvvvvvvvvvvv1.TOUCH_ACTION_MOVE_NOTOUCH) { 
if (true) return "";};
 //BA.debugLineNum = 265;BA.debugLine="AlphaBarSelectedChange(x)";
_vvvvvvvvvvvvvvvvvv6(_x);
 //BA.debugLineNum = 266;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvv6(float _x) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvv7 = (int) (255*__c.Max(0,__c.Min(1,_x/(double)_vvvvvvvvvvvvvvvvvvvvvv1.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth())));
 //BA.debugLineNum = 149;BA.debugLine="x = SelectedAlpha / 255 * AlphaBar.pnl.Width";
_x = (float) (_vvvvvvvvvvvvvvvvvvvv7/(double)255*_vvvvvvvvvvvvvvvvvvvvvv1.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth());
 //BA.debugLineNum = 150;BA.debugLine="AlphaBar.cvs.ClearRect(AlphaBar.cvs.TargetRect)";
_vvvvvvvvvvvvvvvvvvvvvv1.cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .ClearRect(_vvvvvvvvvvvvvvvvvvvvvv1.cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .getTargetRect());
...
_r.Initialize((float) (_x-__c.DipToCurrent((int) (3))),(float) (__c.DipToCurrent((int) (1))),(float) (_x+__c.DipToCurrent((int) (3))),(float) (_vvvvvvvvvvvvvvvvvvvvvv1.cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .getTargetRect().getBottom()-__c.DipToCurrent((int) (1))));
 //BA.debugLineNum = 153;BA.debugLine="AlphaBar.cvs.DrawRect(r, xui.Color_Black, True, 2";
_vvvvvvvvvvvvvvvvvvvvvv1.cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .DrawRect(_r,_vvvvvvvvvvvvv2.Color_Black,__c.True,(float) (__c.DipToCurrent((int) (2))));
 //BA.debugLineNum = 154;BA.debugLine="AlphaBar.cvs.Invalidate";
_vvvvvvvvvvvvvvvvvvvvvv1.cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .Invalidate();
...
int _r = 0;
int _w = 0;
com.testdb.b4xcolortemplate._colorpickerpart _cpp = null;
int _i = 0;
...
_vvvvvvvvvvvvvvvvvvvvv5 = (float) (__c.Max(1,__c.Max(_width,_height)/(double)100/(double)_vvvvvvvvvvvvvvvvvvvvv4));
 //BA.debugLineNum = 54;BA.debugLine="HueBar.pnl.SetLayoutAnimated(0, 1dip, 1dip, 30dip";
_vvvvvvvvvvvvvvvvvvvvv7.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetLayoutAnimated((int) (0),__c.DipToCurrent((int) (1)),__c.DipToCurrent((int) (1)),__c.DipToCurrent((int) (30)),(int) (_height-__c.DipToCurrent((int) (2))));
 //BA.debugLineNum = 55;BA.debugLine="Dim r As Int = HueBar.pnl.Width + HueBar.pnl.Left";
_r = (int) (_vvvvvvvvvvvvvvvvvvvvv7.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth()+_vvvvvvvvvvvvvvvvvvvvv7.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getLeft()+__c.DipToCurrent((int) (1)));
...
_vvvvvvvvvvvvvvvvvvvvvv1.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetLayoutAnimated((int) (0),_r,(int) (_height-__c.DipToCurrent((int) (31))),_w,__c.DipToCurrent((int) (30)));
 //BA.debugLineNum = 62;BA.debugLine="ColorPicker.pnl.SetLayoutAnimated(0, r, 1dip, w,";
_vvvvvvvvvvvvvvvvvvvvv0.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetLayoutAnimated((int) (0),_r,__c.DipToCurrent((int) (1)),_w,(int) (_height-__c.DipToCurrent((int) (3))-_vvvvvvvvvvvvvvvvvvvvvv1.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()));
 //BA.debugLineNum = 63;BA.debugLine="bcColors.Initialize(ColorPicker.pnl.Width / Color";
_vvvvvvvvvvvvvvvvvvvv0._initialize(ba,(int) (_vvvvvvvvvvvvvvvvvvvvv0.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth()/(double)_vvvvvvvvvvvvvvvvvvvvv5),(int) (_vvvvvvvvvvvvvvvvvvvvv0.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()/(double)_vvvvvvvvvvvvvvvvvvvvv5));
 //BA.debugLineNum = 64;BA.debugLine="For Each cpp As ColorPickerPart In Array(HueBar,";
{
final Object[] group12 = new Object[]{(Object)(_vvvvvvvvvvvvvvvvvvvvv7),(Object)(_vvvvvvvvvvvvvvvvvvvvv0),(Object)(_vvvvvvvvvvvvvvvvvvvvvv1)};
final int groupLen12 = group12.length
;int index12 = 0;
;
for (; index12 < groupLen12;index12++){
_cpp = (com.testdb.b4xcolortemplate._colorpickerpart)(group12[index12]);
...
_vvvvvvvvvvvvvvvvvvv2(_cpp);
 };
 }
};
 //BA.debugLineNum = 73;BA.debugLine="DrawHueBar";
_vvvvvvvvvvvvvvvvvvv4();
...
_vvvvvvvvvvvvvvvvvvv0((float) (_vvvvvvvvvvvvvvvvvvvvv1/(double)360*_vvvvvvvvvvvvvvvvvvvvv7.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()));
 //BA.debugLineNum = 76;BA.debugLine="AlphaBarSelectedChange (SelectedAlpha / 255 * Alp";
_vvvvvvvvvvvvvvvvvv6((float) (_vvvvvvvvvvvvvvvvvvvv7/(double)255*_vvvvvvvvvvvvvvvvvvvvvv1.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth()));
...
_vvvvvvvvvvvvvvvvvvvv7 = (int) (255);
 //BA.debugLineNum = 5;BA.debugLine="Private bcColors As BitmapCreator";
_vvvvvvvvvvvvvvvvvvvv0 = new b4a.example.bitmapcreator();
 //BA.debugLineNum = 6;BA.debugLine="Private selectedH = 60, selectedS = 0.5, selected";
_vvvvvvvvvvvvvvvvvvvvv1 = (float) (60);
_vvvvvvvvvvvvvvvvvvvvv2 = (float) (0.5);
_vvvvvvvvvvvvvvvvvvvvv3 = (float) (0.5);
 //BA.debugLineNum = 7;BA.debugLine="Private DeviceScale, ColorScale As Float";
_vvvvvvvvvvvvvvvvvvvvv4 = 0f;
_vvvvvvvvvvvvvvvvvvvvv5 = 0f;
 //BA.debugLineNum = 8;BA.debugLine="Private tempBC As BitmapCreator";
_vvvvvvvvvvvvvvvvvvvvv6 = new b4a.example.bitmapcreator();
...
_vvvvvvvvvvvvvvvvvvvvv7 = new com.testdb.b4xcolortemplate._colorpickerpart();
_vvvvvvvvvvvvvvvvvvvvv0 = new com.testdb.b4xcolortemplate._colorpickerpart();
_vvvvvvvvvvvvvvvvvvvvvv1 = new com.testdb.b4xcolortemplate._colorpickerpart();
...
_vvvvvvvvvvvvvvvvvvvvvv4 = new Object[(int) (0)];
{
int d0 = _vvvvvvvvvvvvvvvvvvvvvv4.length;
for (int i0 = 0;i0 < d0;i0++) {
_vvvvvvvvvvvvvvvvvvvvvv4[i0] = new Object();
}
}
;
...
_vvvvvvvvvvvvvvvvvvv7((int) (_x),(int) (_y));
 //BA.debugLineNum = 256;BA.debugLine="End Sub";
return "";
}
public Object[]  _vvvvvvvvvvvvvvvvvv7(int _clr) throws Exception{
int _a = 0;
int _r = 0;
int _g = 0;
int _b = 0;
...
public com.testdb.b4xcolortemplate._colorpickerpart  _vvvvvvvvvvvvvvvvvv0(String _eventname,boolean _withcheckers) throws Exception{
com.testdb.b4xcolortemplate._colorpickerpart _cpp = null;
...
_cpp = new com.testdb.b4xcolortemplate._colorpickerpart();
 //BA.debugLineNum = 32;BA.debugLine="cpp.Initialize";
_cpp.Initialize();
 //BA.debugLineNum = 33;BA.debugLine="cpp.pnl = xui.CreatePanel(\"\")";
_cpp.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/  = _vvvvvvvvvvvvv2.CreatePanel(ba,"");
 //BA.debugLineNum = 34;BA.debugLine="cpp.pnl.SetColorAndBorder(BordersColor, 1dip, Bor";
_cpp.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetColorAndBorder(_vvvvvvvvvvvvvvvvvvvvvv2,__c.DipToCurrent((int) (1)),_vvvvvvvvvvvvvvvvvvvvvv2,(int) (0));
...
_overlay = _vvvvvvvvvvvvv2.CreatePanel(ba,_eventname);
...
_vvvvvvvvvvvvv1.AddView((android.view.View)(_cpp.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getObject()),(int) (0),(int) (0),(int) (0),(int) (0));
...
_setvvvvvvvvvvvvvvvvvvvv6(_vvvvvvvvvvvvvvvvvvvvvv4);
 };
...
_bc._initialize(ba,(int) (_vvvvvvvvvvvvvvvvvvvvvv1.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth()/(double)_vvvvvvvvvvvvvvvvvvvvv4),(int) (_vvvvvvvvvvvvvvvvvvvvvv1.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()/(double)_vvvvvvvvvvvvvvvvvvvvv4));
...
_vvvvvvvvvvvvvvvvvvvvvv1.iv /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetBitmap((android.graphics.Bitmap)(_bc._getbitmap().getObject()));
 //BA.debugLineNum = 124;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvv2(com.testdb.b4xcolortemplate._colorpickerpart _cpp) throws Exception{
int _size = 0;
int[] _clrs = null;
int _clr = 0;
anywheresoftware.b4a.objects.B4XCanvas.B4XRect _r = null;
...
public String  _vvvvvvvvvvvvvvvvvvv3() throws Exception{
int _x = 0;
int _y = 0;
...
{
final int step1 = 1;
final int limit1 = (int) (_vvvvvvvvvvvvvvvvvvvv0._mwidth-1);
_x = (int) (0) ;
for (;_x <= limit1 ;_x = _x + step1 ) {
 //BA.debugLineNum = 128;BA.debugLine="For y = 0 To bcColors.mHeight - 1";
{
final int step2 = 1;
final int limit2 = (int) (_vvvvvvvvvvvvvvvvvvvv0._mheight-1);
_y = (int) (0) ;
for (;_y <= limit2 ;_y = _y + step2 ) {
 //BA.debugLineNum = 129;BA.debugLine="bcColors.SetHSV(x, y, SelectedAlpha, selectedH,";
_vvvvvvvvvvvvvvvvvvvv0._sethsv(_x,_y,_vvvvvvvvvvvvvvvvvvvv7,(int) (_vvvvvvvvvvvvvvvvvvvvv1),(float) (_x/(double)_vvvvvvvvvvvvvvvvvvvv0._mwidth),(float) ((_vvvvvvvvvvvvvvvvvvvv0._mheight-_y)/(double)_vvvvvvvvvvvvvvvvvvvv0._mheight));
 }
};
 }
};
 //BA.debugLineNum = 133;BA.debugLine="ColorPicker.iv.SetBitmap(bcColors.Bitmap.Resize(C";
_vvvvvvvvvvvvvvvvvvvvv0.iv /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetBitmap((android.graphics.Bitmap)(_vvvvvvvvvvvvvvvvvvvv0._getbitmap().Resize(_vvvvvvvvvvvvvvvvvvvvv0.iv /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth(),_vvvvvvvvvvvvvvvvvvvvv0.iv /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight(),__c.False).getObject()));
 //BA.debugLineNum = 134;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvv4() throws Exception{
...
_bchue._initialize(ba,(int) (_vvvvvvvvvvvvvvvvvvvvv7.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth()/(double)_vvvvvvvvvvvvvvvvvvvvv4),(int) (_vvvvvvvvvvvvvvvvvvvvv7.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()/(double)_vvvvvvvvvvvvvvvvvvvvv4));
...
_vvvvvvvvvvvvvvvvvvvvv7.iv /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetBitmap((android.graphics.Bitmap)(_bchue._getbitmap().getObject()));
...
public int  _getvvvvvvvvvvvvvvvvvvvv5() throws Exception{
Object[] _hsv = null;
...
_hsv = _getvvvvvvvvvvvvvvvvvvvv6();
 //BA.debugLineNum = 177;BA.debugLine="tempBC.SetHSV(0, 0, SelectedAlpha, hsv(0), hsv(1)";
_vvvvvvvvvvvvvvvvvvvvv6._sethsv((int) (0),(int) (0),_vvvvvvvvvvvvvvvvvvvv7,(int)(BA.ObjectToNumber(_hsv[(int) (0)])),(float)(BA.ObjectToNumber(_hsv[(int) (1)])),(float)(BA.ObjectToNumber(_hsv[(int) (2)])));
 //BA.debugLineNum = 178;BA.debugLine="Return tempBC.GetColor(0, 0)";
if (true) return _vvvvvvvvvvvvvvvvvvvvv6._getcolor((int) (0),(int) (0));
 //BA.debugLineNum = 179;BA.debugLine="End Sub";
return 0;
}
public Object[]  _getvvvvvvvvvvvvvvvvvvvv6() throws Exception{
...
if (true) return new Object[]{(Object)(_vvvvvvvvvvvvvvvvvvvvv1),(Object)(_vvvvvvvvvvvvvvvvvvvvv2),(Object)(_vvvvvvvvvvvvvvvvvvvvv3),(Object)(_vvvvvvvvvvvvvvvvvvvv7)};
 //BA.debugLineNum = 188;BA.debugLine="End Sub";
return null;
}
public String  _vvvvvvvvvvvvvvvvvvv7(int _x,int _y) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvv2 = (float) (__c.Max(0,__c.Min(1,_x/(double)_vvvvvvvvvvvvvvvvvvvvv0.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth())));
 //BA.debugLineNum = 166;BA.debugLine="selectedV = Max(0, Min(1, (ColorPicker.pnl.Heigh";
_vvvvvvvvvvvvvvvvvvvvv3 = (float) (__c.Max(0,__c.Min(1,(_vvvvvvvvvvvvvvvvvvvvv0.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()-_y)/(double)_vvvvvvvvvvvvvvvvvvvvv0.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight())));
 };
 //BA.debugLineNum = 168;BA.debugLine="ColorPicker.cvs.ClearRect(ColorPicker.cvs.TargetR";
_vvvvvvvvvvvvvvvvvvvvv0.cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .ClearRect(_vvvvvvvvvvvvvvvvvvvvv0.cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .getTargetRect());
 //BA.debugLineNum = 169;BA.debugLine="ColorPicker.cvs.DrawCircle(selectedS * ColorPicke";
_vvvvvvvvvvvvvvvvvvvvv0.cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .DrawCircle((float) (_vvvvvvvvvvvvvvvvvvvvv2*_vvvvvvvvvvvvvvvvvvvvv0.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth()),(float) (_vvvvvvvvvvvvvvvvvvvvv0.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()-_vvvvvvvvvvvvvvvvvvvvv3*_vvvvvvvvvvvvvvvvvvvvv0.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()),(float) (__c.DipToCurrent((int) (10))),_vvvvvvvvvvvvv2.Color_White,__c.False,(float) (__c.DipToCurrent((int) (2))));
 //BA.debugLineNum = 171;BA.debugLine="ColorPicker.cvs.Invalidate";
_vvvvvvvvvvvvvvvvvvvvv0.cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .Invalidate();
...
_vvvvvvvvvvvvvvvvvvv0(_y);
 //BA.debugLineNum = 261;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvv0(float _y) throws Exception{
anywheresoftware.b4a.objects.B4XCanvas.B4XRect _r = null;
...
_vvvvvvvvvvvvvvvvvvvvv1 = (float) (__c.Max(0,__c.Min(360,360*_y/(double)_vvvvvvvvvvvvvvvvvvvvv7.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight())));
 //BA.debugLineNum = 138;BA.debugLine="y = selectedH * HueBar.pnl.Height / 360";
_y = (float) (_vvvvvvvvvvvvvvvvvvvvv1*_vvvvvvvvvvvvvvvvvvvvv7.pnl /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()/(double)360);
 //BA.debugLineNum = 139;BA.debugLine="HueBar.cvs.ClearRect(HueBar.cvs.TargetRect)";
_vvvvvvvvvvvvvvvvvvvvv7.cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .ClearRect(_vvvvvvvvvvvvvvvvvvvvv7.cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .getTargetRect());
...
_r.Initialize((float) (0),(float) (_y-__c.DipToCurrent((int) (3))),_vvvvvvvvvvvvvvvvvvvvv7.cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .getTargetRect().getRight(),(float) (_y+__c.DipToCurrent((int) (3))));
 //BA.debugLineNum = 142;BA.debugLine="HueBar.cvs.DrawRect(r, xui.Color_White, False, 2d";
_vvvvvvvvvvvvvvvvvvvvv7.cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .DrawRect(_r,_vvvvvvvvvvvvv2.Color_White,__c.False,(float) (__c.DipToCurrent((int) (2))));
 //BA.debugLineNum = 143;BA.debugLine="HueBar.cvs.Invalidate";
_vvvvvvvvvvvvvvvvvvvvv7.cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .Invalidate();
...
_vvvvvvvvvvvvvvvvvvvvv6._initialize(ba,(int) (1),(int) (1));
 //BA.debugLineNum = 19;BA.debugLine="DeviceScale = 100dip / 100";
_vvvvvvvvvvvvvvvvvvvvv4 = (float) (__c.DipToCurrent((int) (100))/(double)100);
 //BA.debugLineNum = 20;BA.debugLine="mBase = xui.CreatePanel(\"\")";
_vvvvvvvvvvvvv1 = _vvvvvvvvvvvvv2.CreatePanel(ba,"");
 //BA.debugLineNum = 21;BA.debugLine="mBase.SetLayoutAnimated(0, 0, 0, 300dip, 250dip)";
_vvvvvvvvvvvvv1.SetLayoutAnimated((int) (0),(int) (0),(int) (0),__c.DipToCurrent((int) (300)),__c.DipToCurrent((int) (250)));
 //BA.debugLineNum = 22;BA.debugLine="BordersColor = xui.Color_Black";
_vvvvvvvvvvvvvvvvvvvvvv2 = _vvvvvvvvvvvvv2.Color_Black;
 //BA.debugLineNum = 23;BA.debugLine="mBase.SetColorAndBorder(BordersColor, 1dip, Borde";
_vvvvvvvvvvvvv1.SetColorAndBorder(_vvvvvvvvvvvvvvvvvvvvvv2,__c.DipToCurrent((int) (1)),_vvvvvvvvvvvvvvvvvvvvvv2,__c.DipToCurrent((int) (2)));
 //BA.debugLineNum = 24;BA.debugLine="HueBar = CreatePanelForBitmapCreator(\"hueBar\", Fa";
_vvvvvvvvvvvvvvvvvvvvv7 = _vvvvvvvvvvvvvvvvvv0("hueBar",__c.False);
 //BA.debugLineNum = 25;BA.debugLine="ColorPicker = CreatePanelForBitmapCreator(\"colors";
_vvvvvvvvvvvvvvvvvvvvv0 = _vvvvvvvvvvvvvvvvvv0("colors",__c.True);
 //BA.debugLineNum = 26;BA.debugLine="AlphaBar = CreatePanelForBitmapCreator(\"alpha\", T";
_vvvvvvvvvvvvvvvvvvvvvv1 = _vvvvvvvvvvvvvvvvvv0("alpha",__c.True);
...
public String  _setvvvvvvvvvvvvvvvvvvvv5(int _i) throws Exception{
...
_setvvvvvvvvvvvvvvvvvvvv6(_vvvvvvvvvvvvvvvvvv7(_i));
 //BA.debugLineNum = 183;BA.debugLine="End Sub";
return "";
}
public String  _setvvvvvvvvvvvvvvvvvvvv6(Object[] _hsv) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvv1 = (float)(BA.ObjectToNumber(_hsv[(int) (0)]));
 //BA.debugLineNum = 192;BA.debugLine="selectedS = HSV(1)";
_vvvvvvvvvvvvvvvvvvvvv2 = (float)(BA.ObjectToNumber(_hsv[(int) (1)]));
 //BA.debugLineNum = 193;BA.debugLine="selectedV = HSV(2)";
_vvvvvvvvvvvvvvvvvvvvv3 = (float)(BA.ObjectToNumber(_hsv[(int) (2)]));
 //BA.debugLineNum = 194;BA.debugLine="SelectedAlpha = HSV(3)";
_vvvvvvvvvvvvvvvvvvvv7 = (int)(BA.ObjectToNumber(_hsv[(int) (3)]));
...
public ResumableSub_Show(com.testdb.b4xcolortemplate parent,com.testdb.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
com.testdb.b4xcolortemplate parent;
...
parent._vvvvvvvvvvvvvvvvvvvvvv4 = parent._getvvvvvvvvvvvvvvvvvvvv6();
...
_vvvvvvvvvvvvvvvvvvv7(_dont_change,_dont_change);
...
if (_vvvvvvvvvvvvvvvvvvvvvv3.IsInitialized /*boolean*/ () && _vvvvvvvvvvvvvvvvvvvvvv3._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .IsInitialized()) { 
 //BA.debugLineNum = 249;BA.debugLine="xDialog.TitleBar.Color = getSelectedColor";
_vvvvvvvvvvvvvvvvvvvvvv3._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setColor(_getvvvvvvvvvvvvvvvvvvvv5());
 };
