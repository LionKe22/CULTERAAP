...
public class b4xbitset extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.testdb.b4xbitset");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.testdb.b4xbitset.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public int[] _vvvvvvvv7 = null;
...
_vvvvvvvv7 = new int[(int) (__c.Bit.ShiftRight(_vvvvvvvv0,(int) (5))+1)];
;
 //BA.debugLineNum = 59;BA.debugLine="End Sub";
return "";
}
public boolean  _vvvvvvvv3(int _index) throws Exception{
int _dindex = 0;
int _offset = 0;
int _blockvalue = 0;
...
_blockvalue = _vvvvvvvv7[_dindex];
...
public String  _vvvvvvvv5(int _index,boolean _value) throws Exception{
int _dindex = 0;
int _offset = 0;
int _blockvalue = 0;
...
_vvvvvvvv7[_dindex] = _newblockvalue;
