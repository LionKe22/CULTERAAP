...
public class b4xlongtexttemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.testdb.b4xlongtexttemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.testdb.b4xlongtexttemplate.class).invoke(this, new Object[] {null});
        else
...
public Object _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = new Object();
...
_vvvvvvvvvvvvv1.LoadLayout("LongTextTemplate",ba);
...
_customlistview1._addtextitem(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3,(Object)(""));
...
_dialog._vvvvvvvvvvvvvvvvvvvvvvvvvvvv2 /*String*/ (_customlistview1,_customlistview1._defaulttextbackgroundcolor);
