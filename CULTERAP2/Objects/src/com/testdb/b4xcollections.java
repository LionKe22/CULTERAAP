...
public static com.testdb.b4xbitset  _v6(anywheresoftware.b4a.BA _ba,int _size) throws Exception{
com.testdb.b4xbitset _s = null;
...
public static com.testdb.b4xorderedmap  _v7(anywheresoftware.b4a.BA _ba) throws Exception{
...
if (true) return _v0(_ba,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)),(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 32;BA.debugLine="End Sub";
return null;
}
public static com.testdb.b4xorderedmap  _v0(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _keys,anywheresoftware.b4a.objects.collections.List _values) throws Exception{
com.testdb.b4xorderedmap _m = null;
int _i = 0;
...
_m = new com.testdb.b4xorderedmap();
...
_m._vvvvvvvvvvv2 /*String*/ (_keys.Get(_i),_values.Get(_i));
 }
};
 };
...
public static com.testdb.b4xset  _vv1(anywheresoftware.b4a.BA _ba) throws Exception{
 //BA.debugLineNum = 9;BA.debugLine="Public Sub CreateSet As B4XSet";
 //BA.debugLineNum = 10;BA.debugLine="Return CreateSet2(Null)";
if (true) return _vv2(_ba,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 11;BA.debugLine="End Sub";
return null;
}
public static com.testdb.b4xset  _vv2(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _values) throws Exception{
com.testdb.b4xset _s = null;
Object _v = null;
