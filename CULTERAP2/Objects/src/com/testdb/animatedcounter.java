...
public class animatedcounter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.testdb.animatedcounter");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.testdb.animatedcounter.class).invoke(this, new Object[] {null});
        else
...
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvvvvvv3 = null;
public int _vvvvvvvvvvvvv4 = 0;
public anywheresoftware.b4a.objects.B4XViewWrapper _vvvvvvvvvvvvv5 = null;
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvvvvvv6 = null;
public int _vvvvvvvvvvvvv7 = 0;
public int _vvvvvvvvvvvvv0 = 0;
public int _vvvvvvvvvvvvvv1 = 0;
public anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper _vvvvvvvvvvvvvv2 = null;
public anywheresoftware.b4a.objects.B4XViewWrapper _vvvvvvvvvvvvvv3 = null;
...
_vvvvvvvvvvvvv3 = new anywheresoftware.b4a.objects.collections.List();
...
_vvvvvvvvvvvvv6 = new anywheresoftware.b4a.objects.collections.List();
...
_vvvvvvvvvvvvvv2 = new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper();
 //BA.debugLineNum = 17;BA.debugLine="Private xfadeIv As B4XView";
_vvvvvvvvvvvvvv3 = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Public Tag As Object";
_vvvvvvv4 = new Object();
 //BA.debugLineNum = 20;BA.debugLine="End Sub";
return "";
}
public anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper  _vvvvvvvvvvvv1(anywheresoftware.b4a.objects.B4XViewWrapper _lbl) throws Exception{
...
_p.SetLayoutAnimated((int) (0),(int) (0),(int) (0),_vvvvvvvvvvvvv0,(int) (_vvvvvvvvvvvvv7*10));
...
_baseline = (int) (_vvvvvvvvvvvvv7/(double)2-_r.getHeight()/(double)2-_r.getTop());
...
_cvs.DrawText(ba,BA.NumberToString(_i),(float) (_vvvvvvvvvvvvv0/(double)2),(float) (_i*_vvvvvvvvvvvvv7+_baseline),_lbl.getFont(),_lbl.getTextColor(),BA.getEnumFromString(android.graphics.Paint.Align.class,"CENTER"));
 }
};
...
public anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper  _vvvvvvvvvvvv2(int _clr) throws Exception{
...
_pnl = _vvvvvvvvvvvvv2.CreatePanel(ba,"");
 //BA.debugLineNum = 34;BA.debugLine="mBase.AddView(pnl, 0, 0, 0, 0)";
_vvvvvvvvvvvvv1.AddView((android.view.View)(_pnl.getObject()),(int) (0),(int) (0),(int) (0),(int) (0));
 //BA.debugLineNum = 35;BA.debugLine="mdigits = Props.Get(\"Digits\")";
_vvvvvvvvvvvvv4 = (int)(BA.ObjectToNumber(_props.Get((Object)("Digits"))));
 //BA.debugLineNum = 36;BA.debugLine="mDuration = Props.Get(\"Duration\")";
_vvvvvvvvvvvvvv1 = (int)(BA.ObjectToNumber(_props.Get((Object)("Duration"))));
 //BA.debugLineNum = 37;BA.debugLine="lblTemplate = lbl";
_vvvvvvvvvvvvv5.setObject((java.lang.Object)(_lbl.getObject()));
 //BA.debugLineNum = 38;BA.debugLine="fade = CreateFadeBitmap(xui.PaintOrColorToColor(P";
_vvvvvvvvvvvvvv2 = _vvvvvvvvvvvv2(_vvvvvvvvvvvvv2.PaintOrColorToColor(_props.GetDefault((Object)("FadeColor"),(Object)(_vvvvvvvvvvvvv2.Color_White))));
 //BA.debugLineNum = 39;BA.debugLine="For i = 0 To mdigits - 1";
{
final int step10 = 1;
final int limit10 = (int) (_vvvvvvvvvvvvv4-1);
_i = (int) (0) ;
...
_vvvvvvvvvvvvv3.Add((Object)(_iv.getObject()));
 //BA.debugLineNum = 43;BA.debugLine="mBase.GetView(0).AddView(iv, 0, 0, 0, 0)";
_vvvvvvvvvvvvv1.GetView((int) (0)).AddView((android.view.View)(_iv.getObject()),(int) (0),(int) (0),(int) (0),(int) (0));
 }
};
...
_vvvvvvvvvvvvvv3.setObject((java.lang.Object)(_fadeiv.getObject()));
 //BA.debugLineNum = 48;BA.debugLine="mBase.GetView(0).AddView(fadeIv, 0, 0, 0, 0)";
_vvvvvvvvvvvvv1.GetView((int) (0)).AddView((android.view.View)(_fadeiv.getObject()),(int) (0),(int) (0),(int) (0),(int) (0));
 //BA.debugLineNum = 49;BA.debugLine="setValue(0)";
_setvvvvvvvvvvvv6((int) (0));
...
_setvvvvvvvvvvvv6(_getvvvvvvvvvvvv6());
 };
...
{
final int step2 = 1;
final int limit2 = (int) (_vvvvvvvvvvvvv6.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit2 ;_i = _i + step2 ) {
 //BA.debugLineNum = 123;BA.debugLine="res = res + mValue.Get(i) * Power(10, i)";
_res = (int) (_res+(double)(BA.ObjectToNumber(_vvvvvvvvvvvvv6.Get(_i)))*__c.Power(10,_i));
 }
};
...
{
final int step2 = 1;
final int limit2 = (int) (_vvvvvvvvvvvvv4-1);
_i = (int) (0) ;
for (;_i <= limit2 ;_i = _i + step2 ) {
 //BA.debugLineNum = 112;BA.debugLine="mValue.Add(v Mod 10)";
_vvvvvvvvvvvvv6.Add((Object)(_v%10));
...
_iv.SetLayoutAnimated(_vvvvvvvvvvvvvv1,_iv.getLeft(),_vvvvvvvvvvvv5(_i),(int) (__c.Max(1,_iv.getWidth())),(int) (__c.Max(1,_iv.getHeight())));
 }
};
 //BA.debugLineNum = 118;BA.debugLine="End Sub";
return "";
}
public int  _vvvvvvvvvvvv5(int _digit) throws Exception{
int _d = 0;
...
_d = (int)(BA.ObjectToNumber(_vvvvvvvvvvvvv6.Get(_digit)));
 //BA.debugLineNum = 90;BA.debugLine="Return -d * DigitHeight";
if (true) return (int) (-_d*_vvvvvvvvvvvvv7);
