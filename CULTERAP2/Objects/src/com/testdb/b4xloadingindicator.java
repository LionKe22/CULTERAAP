...
public class b4xloadingindicator extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.testdb.b4xloadingindicator");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.testdb.b4xloadingindicator.class).invoke(this, new Object[] {null});
        else
...
public int _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = 0;
...
public String _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = "";
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = 0;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = 0;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = _vvvvvvvvvvvvv2.PaintOrColorToColor(_props.Get((Object)("Color")));
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = (int)(BA.ObjectToNumber(_props.Get((Object)("Duration"))));
 //BA.debugLineNum = 32;BA.debugLine="DrawingSubName = \"Draw_\" & style.Replace(\" \", \"\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = "Draw_"+_style.replace(" ","");
...
_r = (float) (_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterX()-__c.DipToCurrent((int) (5)));
...
_p.InitializeArc(_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterX(),_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterY(),_r,(float) (-90),(float) (_progress*2*360));
 }else {
 //BA.debugLineNum = 111;BA.debugLine="p.InitializeArc(cvs.TargetRect.CenterX, cvs.Targ";
_p.InitializeArc(_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterX(),_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterY(),_r,(float) (-90),(float) (-(1-_progress)*2*360));
 };
 //BA.debugLineNum = 113;BA.debugLine="cvs.ClipPath(p)";
_vvvvvvvvvvvvvvvvv5.ClipPath(_p);
 //BA.debugLineNum = 114;BA.debugLine="cvs.DrawRect(cvs.TargetRect, clr, True, 0)";
_vvvvvvvvvvvvvvvvv5.DrawRect(_vvvvvvvvvvvvvvvvv5.getTargetRect(),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3,__c.True,(float) (0));
 //BA.debugLineNum = 115;BA.debugLine="cvs.RemoveClip";
_vvvvvvvvvvvvvvvvv5.RemoveClip();
...
_p.InitializeArc(_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterX(),_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterY(),_r,(float) (-90),(float) (360-(_progress-0.5)*2*360));
 };
...
_maxr = (int) (_vvvvvvvvvvvvvvvvv5.getTargetRect().getHeight()/(double)2);
 //BA.debugLineNum = 98;BA.debugLine="Dim dx As Int = (cvs.TargetRect.Width - 2dip) / 5";
_dx = (int) ((_vvvvvvvvvvvvvvvvv5.getTargetRect().getWidth()-__c.DipToCurrent((int) (2)))/(double)5);
...
_vvvvvvvvvvvvvvvvv5.DrawLine((float) (__c.DipToCurrent((int) (2))+_i*_dx),(float) (_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterY()-_r),(float) (__c.DipToCurrent((int) (2))+_i*_dx),(float) (_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterY()+_r),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3,(float) (__c.DipToCurrent((int) (4))));
 }
};
...
_vvvvvvvvvvvvvvvvv5.DrawCircle((float) (_vvvvvvvvvvvvvvvvv5.getTargetRect().getWidth()-_dotr-_progress*(_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterX()-__c.DipToCurrent((int) (10)))),_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterY(),(float) (_dotr),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3,(int) (255-200*_progress)),__c.True,(float) (0));
...
_cx = (int) (_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterX()-__c.DipToCurrent((int) (5)));
 //BA.debugLineNum = 137;BA.debugLine="Dim cy As Int = cvs.TargetRect.CenterY";
_cy = (int) (_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterY());
 //BA.debugLineNum = 138;BA.debugLine="Dim r As Int = cvs.TargetRect.CenterY - 5dip";
_r = (int) (_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterY()-__c.DipToCurrent((int) (5)));
 //BA.debugLineNum = 139;BA.debugLine="If angle = 0 Then";
if (_angle==0) { 
 //BA.debugLineNum = 140;BA.debugLine="cvs.DrawCircle(cx, cy, r, clr, True, 0)";
_vvvvvvvvvvvvvvvvv5.DrawCircle((float) (_cx),(float) (_cy),(float) (_r),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3,__c.True,(float) (0));
 }else {
...
_vvvvvvvvvvvvvvvvv5.DrawCircle(_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterX(),_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterY(),(float) (_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterX()*_progress),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3,(int) (255-255*_progress)),__c.True,(float) (0));
 }
};
...
_maxr = (float) ((_vvvvvvvvvvvvvvvvv5.getTargetRect().getWidth()/(double)2-__c.DipToCurrent((int) (20)))/(double)2);
...
_vvvvvvvvvvvvvvvvv5.DrawCircle((float) (_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterX()+_r*__c.SinD(_alpha)),(float) (_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterY()+_r*__c.CosD(_alpha)),(float) (__c.DipToCurrent((int) (7))),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3,__c.True,(float) (__c.DipToCurrent((int) (1))));
 }
};
...
_maxr = (int) (_vvvvvvvvvvvvvvvvv5.getTargetRect().getWidth()/(double)2/(double)3-_minr-__c.DipToCurrent((int) (2)));
...
_vvvvvvvvvvvvvvvvv5.DrawCircle((float) (_maxr+_minr+(_minr+_maxr+__c.DipToCurrent((int) (2)))*2*_i),_vvvvvvvvvvvvvvvvv5.getTargetRect().getCenterY(),_r,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3,__c.True,(float) (0));
 }
};
...
_vvvvvvvvvvvvv1.setVisible(__c.False);
...
public void  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1() throws Exception{
...
public ResumableSub_MainLoop(com.testdb.b4xloadingindicator parent) {
this.parent = parent;
}
com.testdb.b4xloadingindicator parent;
int _myindex = 0;
long _n = 0L;
float _progress = 0f;
...
//do while
this.state = 4;
while (_myindex==parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4) {
this.state = 3;
if (true) break;
}
if (true) break;
...
_progress = (float) ((parent.__c.DateTime.getNow()-_n)/(double)parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6);
...
parent._vvvvvvvvvvvvvvvvv5.ClearRect(parent._vvvvvvvvvvvvvvvvv5.getTargetRect());
 //BA.debugLineNum = 50;BA.debugLine="CallSub2(Me, DrawingSubName, progress)";
parent.__c.CallSubNew2(ba,parent,parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5,(Object)(_progress));
 //BA.debugLineNum = 51;BA.debugLine="cvs.Invalidate";
parent._vvvvvvvvvvvvvvvvv5.Invalidate();
...
public int  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(int _c,int _alpha) throws Exception{
...
_vvvvvvvvvvvvv1.setVisible(__c.True);
