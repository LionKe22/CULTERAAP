...
public class httpjob extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.testdb.httpjob");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.testdb.httpjob.class).invoke(this, new Object[] {null});
        else
...
public Object _vvvvvv0 = null;
public String _vvvvvvv1 = "";
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest _vvvvvvv2 = null;
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpResponse _vvvvvvv3 = null;
...
_vvvvvvv2 = new anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest();
 //BA.debugLineNum = 11;BA.debugLine="Public Response As OkHttpResponse";
_vvvvvvv3 = new anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpResponse();
...
_vvvvvvv1 = BA.NumberToString(_id);
 //BA.debugLineNum = 241;BA.debugLine="CallSubDelayed2(target, \"JobDone\", Me)";
__c.CallSubDelayed2(ba,_vvvvvv0,"JobDone",this);
...
_vvvvvvv2.InitializeDelete(_link);
 //BA.debugLineNum = 199;BA.debugLine="CallSubDelayed2(HttpUtils2Service, \"SubmitJob\", M";
__c.CallSubDelayed2(ba,(Object)(_vvvvvvv0.getObject()),"SubmitJob",this);
...
_vvvvvvv2.InitializeDelete(_vvv0(_link,_parameters));
...
_vvvvvvv2.InitializeGet(_vvv0(_link,_parameters));
...
_b = __c.LoadBitmap(_vvvvvvv0._v5 /*String*/ ,_vvvvvvv1);
 //BA.debugLineNum = 257;BA.debugLine="Return b";
if (true) return _b;
 //BA.debugLineNum = 258;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvv2(int _width,int _height,boolean _keepaspectratio) throws Exception{
...
if (true) return __c.LoadBitmapResize(_vvvvvvv0._v5 /*String*/ ,_vvvvvvv1,_width,_height,_keepaspectratio);
 //BA.debugLineNum = 267;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvv3(int _width,int _height) throws Exception{
...
if (true) return __c.LoadBitmapSample(_vvvvvvv0._v5 /*String*/ ,_vvvvvvv1,_width,_height);
 //BA.debugLineNum = 263;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.streams.File.InputStreamWrapper  _vvvv4() throws Exception{
...
_in = __c.File.OpenInput(_vvvvvvv0._v5 /*String*/ ,_vvvvvvv1);
 //BA.debugLineNum = 274;BA.debugLine="Return In";
if (true) return _in;
 //BA.debugLineNum = 275;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest  _vvvv5() throws Exception{
 //BA.debugLineNum = 234;BA.debugLine="Public Sub GetRequest As OkHttpRequest";
 //BA.debugLineNum = 235;BA.debugLine="Return req";
if (true) return _vvvvvvv2;
...
if (true) return _vvvv7("UTF8");
 //BA.debugLineNum = 217;BA.debugLine="End Sub";
return "";
}
public String  _vvvv7(String _encoding) throws Exception{
...
_tr.Initialize2((java.io.InputStream)(__c.File.OpenInput(_vvvvvvv0._v5 /*String*/ ,_vvvvvvv1).getObject()),_encoding);
...
_vvvvvvv2.InitializeHead(_link);
...
_vvvvvv0 = _targetmodule;
 //BA.debugLineNum = 29;BA.debugLine="End Sub";
return "";
}
public boolean  _vvvvv1(anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper _stream,boolean _empty) throws Exception{
...
_vvvvvvv2.InitializePatch2(_link,_data);
...
public String  _vvvvv4(String _link,byte[] _data) throws Exception{
...
_vvvvvvv2.InitializePost2(_link,_data);
 //BA.debugLineNum = 38;BA.debugLine="CallSubDelayed2(HttpUtils2Service, \"SubmitJob\", M";
__c.CallSubDelayed2(ba,(Object)(_vvvvvvv0.getObject()),"SubmitJob",this);
 //BA.debugLineNum = 39;BA.debugLine="End Sub";
return "";
}
public String  _vvvvv5(String _link,String _dir,String _filename) throws Exception{
int _length = 0;
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
...
_vvvvv4(_link,_out.ToBytesArray());
 }else {
 //BA.debugLineNum = 160;BA.debugLine="req.InitializePost(Link, In, length)";
_vvvvvvv2.InitializePost(_link,(java.io.InputStream)(_in.getObject()),_length);
...
public String  _vvvvv6(String _link,anywheresoftware.b4a.objects.collections.Map _namevalues,anywheresoftware.b4a.objects.collections.List _files) throws Exception{
String _boundary = "";
...
String _value = "";
String _s = "";
com.testdb.httpjob._multipartfiledata _fd = null;
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
...
_fd = (com.testdb.httpjob._multipartfiledata)(group17.Get(index17));
...
_vvvvv4(_link,_stream.ToBytesArray());
 //BA.debugLineNum = 124;BA.debugLine="req.SetContentType(\"multipart/form-data; boundary";
_vvvvvvv2.SetContentType("multipart/form-data; boundary="+_boundary);
 //BA.debugLineNum = 125;BA.debugLine="req.SetContentEncoding(\"UTF8\")";
_vvvvvvv2.SetContentEncoding("UTF8");
 //BA.debugLineNum = 126;BA.debugLine="End Sub";
return "";
}
public String  _vvvvv7(String _link,String _text) throws Exception{
...
_vvvvv4(_link,_text.getBytes("UTF8"));
 //BA.debugLineNum = 33;BA.debugLine="End Sub";
return "";
}
public String  _vvvvv0(String _link,byte[] _data) throws Exception{
...
_vvvvvvv2.InitializePut2(_link,_data);
 //BA.debugLineNum = 49;BA.debugLine="CallSubDelayed2(HttpUtils2Service, \"SubmitJob\", M";
__c.CallSubDelayed2(ba,(Object)(_vvvvvvv0.getObject()),"SubmitJob",this);
 //BA.debugLineNum = 50;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvv1(String _link,String _text) throws Exception{
...
_vvvvv0(_link,_text.getBytes("UTF8"));
...
__c.File.Delete(_vvvvvvv0._v5 /*String*/ ,_vvvvvvv1);
